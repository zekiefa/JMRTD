...
public interface ISO781611 {
	...
	int BIOMETRIC_INFORMATION_GROUP_TEMPLATE_TAG = 0x7F61;
	int BIOMETRIC_INFORMATION_TEMPLATE_TAG = 0x7F60;

	int BIOMETRIC_INFO_COUNT_TAG = 0x02;
	int BIOMETRIC_HEADER_TEMPLATE_BASE_TAG = (byte) 0xA1;
	int BIOMETRIC_DATA_BLOCK_TAG = 0x5F2E;
	int BIOMETRIC_DATA_BLOCK_CONSTRUCTED_TAG = 0x7F2E;
	
	int DISCRETIONARY_DATA_FOR_PAYLOAD_TAG = 0x53;
	int DISCRETIONARY_DATA_FOR_PAYLOAD_CONSTRUCTED_TAG = 0x73;
